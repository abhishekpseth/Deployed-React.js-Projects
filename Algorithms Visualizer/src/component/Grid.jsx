...
const Grid = () => {
  ...
  useEffect(() => {
    if (isSimulationStart) {
      ...
      setShortestPathNodeCount(shortestPath.length);
  ...
  return (
    <div className="flex-col justify-center items-center h-[95%] gap-4 flex">
      {!isStatsHidden && (
        <StatBanner
          nodesVisitedCount={nodesVisitedCount}
          shortestPathNodeCount={shortestPathNodeCount}
        />
      )}
      <div
        ref={gridParentRef}
