...
const Table2 = () => {
  ...
  const setTableFocussed = useSheetStore((state) => state.setTableFocussed);
  ...
  return (
    <div
      className="h-[75vh] w-[97vw] relative"
      onMouseEnter={() => setTableFocussed(true)}
      onMouseLeave={() => setTableFocussed(false)}
    >
      ...
      <div className="relative w-full h-full overflow-x-auto overflow-y-auto">
        ...
        <table
          className="w-full border-collapse table-fixed text-lightgrey"
          style={{ userSelect: "none" }}
        >
          <tbody>
                ...
                {row.map((col, colIndex) => (
                  ...
                  <td
                    ...
                    style={{
                      ...
                      opacity: isCellInsideRange(rowIndex, colIndex)
                        ? "0.9"
                        : "1",
